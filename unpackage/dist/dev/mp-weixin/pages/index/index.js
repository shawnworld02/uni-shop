...
try {
  components = {
    uniNavBar: function() {
      return __webpack_require__.e(/*! import() | uni_modules/uni-nav-bar/components/uni-nav-bar/uni-nav-bar */ "uni_modules/uni-nav-bar/components/uni-nav-bar/uni-nav-bar").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-nav-bar/components/uni-nav-bar/uni-nav-bar.vue */ 38))
    }
  }
} catch (e) {
  if (
...
var baseUrl = 'http://192.168.0.101:3000';var _default =

{
  ...
  methods: {
    ...
    __init_wx: function __init_wx() {var _this2 = this;
      uni.request({
        url: baseUrl,
        headers: {
